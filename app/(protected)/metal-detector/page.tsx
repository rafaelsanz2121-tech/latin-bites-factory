            ...
            {logs.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 px-4">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 text-center max-w-xs mb-6">
                  Documenta los chequeos de sensibilidad del detector de metales (CCP) para cumplir con 9 CFR 417.3 y mantener la inocuidad del producto.
                </p>
                <Link href="/metal-detector/nuevo" className="inline-flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold rounded-lg transition-colors shadow-sm">
                  <Plus className="w-4 h-4" />

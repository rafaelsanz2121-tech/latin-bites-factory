    ...
    <div className="max-w-[760px] space-y-6">
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">9 CFR 417.4 · Verificación de proveedores</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className={cardCls}>
          ...
          <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Tipo de empresa</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">No. EST (USDA)</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Contacto</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Teléfono</label>
            ...
            <div className="sm:col-span-2">
              <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Productos que suministra</label>
          ...
          <div className="p-5 grid grid-cols-1 sm:grid-cols-3 gap-3">
            {RISK_OPTIONS.map((r) => (
              <button key={r.value} type="button" onClick={() => setF("risk_level", r.value)}
                className={`text-left p-4 rounded-xl border-2 transition-all ${form.risk_level === r.value ? r.color + " font-semibold shadow-sm" : "border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:border-slate-300 dark:hover:border-slate-600"}`}>
          ...
          <div className="p-5 space-y-4">
            ...
            {form.is_approved && (
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Fecha de aprobación</label>
                  <input type="date" value={form.approval_date} max={today} onChange={(e) => setF("approval_date", e.target.value)} className={inputCls} />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Vence el</label>
        ...
        <div className={cardCls}>
          ...
          {addVerif && (
            <div className="p-5 space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Resultado</label>
                <div className="flex gap-2 flex-wrap">
                  {VERIF_RESULTS.map((r) => (
                    <button key={r.value} type="button" onClick={() => setV("result", r.value)}
                      className={`px-4 py-2 rounded-lg text-sm font-semibold border-2 transition-all ${verif.result === r.value ? r.color : "border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800"}`}>
                      {r.label}
                    </button>
                  ))}
                </div>
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Hallazgos</label>
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Próxima revisión</label>

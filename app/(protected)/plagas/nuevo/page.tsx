    ...
    <div className="max-w-[760px] space-y-6">
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">9 CFR 416.2(a)</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className={cardCls}>
          ...
          <div className="p-5 grid grid-cols-2 sm:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Tipo de inspector</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Inspector / Empresa</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">No. de certificación</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Trampas revisadas</label>
              <input type="number" min={0} value={form.traps_checked} onChange={(e) => setF("traps_checked", e.target.value)} className={inputCls} />
            </div>
            <div>
              <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Trampas con actividad</label>
        ...
        <div className={cardCls}>
          ...
          <div className="p-5 space-y-4">
              ...
              {FINDINGS_OPTIONS.map((f) => (
                <button key={f.value} type="button" onClick={() => setF("findings", f.value)}
                  className={`py-3 rounded-xl border-2 text-sm font-semibold transition-all ${
                    form.findings === f.value ? f.color + " shadow-sm" : "border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:border-slate-300 dark:hover:border-slate-600"
                  }`}>
                  {f.label}
                </button>
              ))}
            ...
            {hasFindings && (
              <>
                <div>
                  <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 mb-2 uppercase tracking-wide">Tipo de plaga *</p>
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Ubicación de la actividad</label>
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Acción correctiva</label>
        ...
        <div className={cardCls}>
          ...
          {form.treatment_performed && (
            <div className="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Tipo de tratamiento</label>
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wide">Productos/Químicos usados</label>

            ...
            {recalls.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 px-4">
                <div className="w-16 h-16 rounded-2xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center mb-4">
                  <RotateCcw className="w-8 h-8 text-slate-400 dark:text-slate-500" />
                </div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 text-center max-w-xs mb-6">
                  Realiza y documenta simulacros de recall para demostrar trazabilidad efectiva del producto. FSMA exige al menos un ejercicio anual.
                </p>
                <Link href="/recall/nuevo" className="inline-flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold rounded-lg transition-colors shadow-sm">
                  <Plus className="w-4 h-4" />

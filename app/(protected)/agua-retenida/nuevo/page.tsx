      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className={cardCls}>
          ...
          <div className="p-5 grid grid-cols-2 sm:grid-cols-3 gap-4">
            ...
            <div className="sm:col-span-2">
              ...
              <input type="text" value={form.product_name} onChange={(e) => setF("product_name", e.target.value)} required placeholder="Ej. Pork Belly Latin Bites" className={inputCls} />
            </div>
            <div>
                ...
                <div className="flex flex-wrap gap-1">
                  {SPECIES_LIMITS.map((s) => (
                    <button key={s.limit + s.label} type="button" onClick={() => setF("regulatory_limit_pct", s.limit)}
                      className="text-[9px] font-bold px-1.5 py-0.5 rounded bg-cyan-100 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-300 hover:bg-cyan-200 transition-colors">
        ...
        {autoResult === "fail" && (
          <div className="bg-red-50 dark:bg-red-900/20 border-2 border-red-200 dark:border-red-800 rounded-xl overflow-hidden">
            ...
            <div className="p-5 space-y-4">
              <div>
                <label className="block text-xs font-semibold text-red-700 dark:text-red-300 mb-1.5 uppercase tracking-wide">Acción tomada *</label>
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <span className="text-sm font-semibold text-red-700 dark:text-red-300">Producto retenido / en cuarentena</span>
              </label>
              {form.product_on_hold && (
                <div>
                  <label className="block text-xs font-semibold text-red-700 dark:text-red-300 mb-1.5 uppercase tracking-wide">Disposición</label>
                      ...
                      <button key={d} type="button" onClick={() => setF("disposition", d)}
                        className={`px-4 py-2 rounded-lg text-sm font-semibold border transition-all ${
                          form.disposition === d
                            ...
                            : "border-red-200 dark:border-red-700 text-red-700 dark:text-red-300 hover:bg-red-100"
                        }`}>

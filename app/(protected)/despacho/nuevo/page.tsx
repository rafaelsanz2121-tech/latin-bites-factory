              ...
              {form.temp_at_loading_f !== "" && (
                <div className="mt-6 flex items-center gap-2">
                  {form.temp_acceptable === "true"
                    ? <span className="flex items-center gap-1.5 text-sm font-bold text-green-600 bg-green-50 dark:bg-green-900/20 px-3 py-1.5 rounded-lg"><CheckCircle2 className="w-4 h-4" /> Dentro del rango</span>
                    : <span className="flex items-center gap-1.5 text-sm font-bold text-red-600 bg-red-50 dark:bg-red-900/20 px-3 py-1.5 rounded-lg"><AlertCircle className="w-4 h-4" /> FUERA DE RANGO</span>
                  }
                </div>
              )}
            </div>

        ...
        <div className={`rounded-xl border-2 overflow-hidden transition-all ${
          ...
          {!form.cleared_for_run && (
            <div className="px-5 pb-5 space-y-3 border-t border-red-200 dark:border-red-800 pt-4">
              <div>
                <label className="block text-xs font-semibold text-red-700 dark:text-red-300 mb-1.5 uppercase tracking-wide">Motivo de retención *</label>
              ...
              <div>
                <label className="block text-xs font-semibold text-red-700 dark:text-red-300 mb-1.5 uppercase tracking-wide">Acción correctiva</label>

...
export default async function AlergenosPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-xl px-5 py-3.5">
        ...
        <div className="flex flex-wrap gap-2">
          {Object.values(ALLERGEN_LABELS).map((label) => (
            <span key={label} className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300">
              {label}
            </span>
          ))}
        </div>
